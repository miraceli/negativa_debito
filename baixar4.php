<?php
	...
	$nomeArquivo = "Negativa de Débito 04-$nrAtendimento";
	...
	<p style="text-align: center; font-size: 16pt; font-family: arial;"><strong>DECLARA&Ccedil;&Atilde;O N&ordm '; print "04-$nrAtendimento"; print '</strong></p>
	<p style="text-align: center;">&nbsp;</p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">Declaramos para os devidos fins, que o imóvel localizado na <strong>'; print "$endCompleto"; print '</strong>, nesta cidade, cadastrado atualmente em nosso banco de dados sob o código nº <strong>';echo "$codImovel"; echo '</strong> e inscrição imobiliária nº <strong>';echo "$inscImobiliaria"; echo '</strong>, encontra-se com a tarifa de coleta de lixo, referente ao período de <strong>';echo "$periodo"; echo '</strong>, devidamente quitado junto a declarante. <br> 
    No mais, a presente declaração não atesta a quitação de débitos anteriores ou posteriores ao período informado acima. <br> 
    Importante ressaltar, que a cobrança da tarifa de coleta de lixo, para os imóveis situados no município de São José, foi realizada no período de Janeiro de 2007 a Julho de 2007 e retomada em Janeiro de 2020.<br> 
    </p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">&nbsp;</p>
	<p style="font-size: 14pt; font-family: arial; text-align: center;">São José, ';echo utf8_encode(strftime( '%d de ' .$uppercaseMonth. ' de %Y', strtotime('today')));echo '.</p>
