<?php
	...
	$periodoTac = isset($_GET['periodoTac']) ? $_GET['periodoTac'] : "";

	$nomeArquivo = "Negativa de Débito 02-$nrAtendimento";
	...
	<p style="text-align: center; font-size: 16pt; font-family: arial;"><strong>DECLARA&Ccedil;&Atilde;O N&ordm '; print "02-$nrAtendimento"; print '</strong></p>
	<p style="text-align: center;">&nbsp;</p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">Declaramos para os devidos fins, que o im&oacute;vel localizado na <strong>'; print "$endCompleto"; print '</strong>, nesta cidade, cadastrado atualmente, em nosso banco de dados sob c&oacute;digo do im&oacute;vel n&ordm; <strong>';echo "$codImovel"; echo '</strong> e DIC <strong>';echo "$nrDic"; echo '</strong>, encontra-se com a tarifa de coleta de lixo, referente ao per&iacute;odo de <strong>';echo "$periodo";echo '</strong>, devidamente quitado junto &agrave; declarante. Os per&iacute;odos <strong>';echo "$periodoTac";echo '</strong> foram estornados conforme TAC. <br /> No mais, a presente declara&ccedil;&atilde;o n&atilde;o atesta a quita&ccedil;&atilde;o de d&eacute;bitos anteriores ou posteriores ao per&iacute;odo informado acima. <br /> Importante ressaltar, que a cobran&ccedil;a da tarifa de coleta de lixo, para os im&oacute;veis situados no munic&iacute;pio de Itaja&iacute;, teve in&iacute;cio a partir de Janeiro de 2004 a dezembro de 2004 e retomada em janeiro de 2013.</p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">&nbsp;</p>
	<p style="font-size: 14pt; font-family: arial; text-align: center;">Itaja&iacute;, ';echo utf8_encode(strftime( '%d de ' .$uppercaseMonth. ' de %Y', strtotime('today')));echo '.</p>
