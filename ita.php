...
while ($exibirRegistros = mysqli_fetch_array($consulta2)) {
  ...
  <div class="form-group">
  <label for="nrDic" class="control-label"><strong>DIC:</strong></label>
  <div class="form-control-static">
    <input style="width:20%; border:none" type="text" id="nrDic" name="nrDic" value="';
  print "$nrDic";
  print '" />
  </div>
  </div>
  ...
  <div class="form-group">
  <label for="periodo" class="control-label"><strong>Período TAC:</strong></label>
  <div class="form-control-static">
    <input class="form-control" style="width:40%" type="text" id="periodoTac" name="periodoTac" value="" />
    <small id="periodoTac" class="form-text text-muted">Digite aqui o período TAC</small>
  </div>
  </div>
