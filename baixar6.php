<?php
	...
	$nomeArquivo = "Negativa de Débito 06-$nrAtendimento";
	...
	<p style="text-align: center; font-size: 16pt; font-family: arial;"><strong>DECLARA&Ccedil;&Atilde;O N&ordm '; print "06-$nrAtendimento"; print '</strong></p>
	<p style="text-align: center;">&nbsp;</p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">Declaramos para os devidos fins, que o imóvel localizado na <strong>'; print "$endCompleto"; print '</strong>, nesta cidade, cadastrado atualmente em nosso banco de dados sob código do imóvel nº <strong>';echo "$codImovel"; echo '</strong>, inscrição imobiliária nº <strong>';echo "$inscImobiliaria"; echo '</strong> e DIC <strong>';echo "$nrDic"; echo '</strong>, encontra-se com a tarifa de coleta de lixo, referente ao período de <strong>'; print "$periodo"; print '</strong>, devidamente quitado junto a declarante.<br> 
    No mais, a presente declaração não atesta a quitação de débitos anteriores ou posteriores ao período informado acima. <br> 
    Importante ressaltar, que a cobrança da tarifa de coleta de lixo, para os imóveis situados no município de São Francisco do Sul, teve início a partir de Janeiro de 2018.<br> 
    </p>
	<p style="text-align: justify; font-size: 14pt; font-family: arial;">&nbsp;</p>
	<p style="font-size: 14pt; font-family: arial; text-align: center;">São Francisco do Sul, ';echo utf8_encode(strftime( '%d de ' .$uppercaseMonth. ' de %Y', strtotime('today')));echo '.</p>
